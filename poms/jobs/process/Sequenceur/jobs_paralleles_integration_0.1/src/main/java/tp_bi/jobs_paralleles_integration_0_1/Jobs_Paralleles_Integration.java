...
package tp_bi.jobs_paralleles_integration_0_1;
...
/**
 * Job: Jobs_Paralleles_Integration Purpose: Séquenceur des jobs de chargements des sources sans l'espace tempraire<br>
 * Description: Séquenceur des jobs de chargements des sources sans l'espace tempraire <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Jobs_Paralleles_Integration implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Jobs_Paralleles_Integration";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Jobs_Paralleles_Integration.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Jobs_Paralleles_Integration.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		tp_bi.stg_dwh_distance_0_1.STG_DWH_DISTANCE childJob_tRunJob_1 = new tp_bi.stg_dwh_distance_0_1.STG_DWH_DISTANCE();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		tp_bi.stg_dwh_direction_0_1.STG_DWH_DIRECTION childJob_tRunJob_2 = new tp_bi.stg_dwh_direction_0_1.STG_DWH_DIRECTION();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		tp_bi.stg_dwh_produit_0_1.STG_DWH_PRODUIT childJob_tRunJob_3 = new tp_bi.stg_dwh_produit_0_1.STG_DWH_PRODUIT();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		tp_bi.stg_dwh_offre_0_1.STG_DWH_OFFRE childJob_tRunJob_4 = new tp_bi.stg_dwh_offre_0_1.STG_DWH_OFFRE();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final Jobs_Paralleles_Integration Jobs_Paralleles_IntegrationClass = new Jobs_Paralleles_Integration();

        int exitCode = Jobs_Paralleles_IntegrationClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Jobs_Paralleles_Integration.class.getClassLoader().getResourceAsStream("tp_bi/jobs_paralleles_integration_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Jobs_Paralleles_Integration.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Jobs_Paralleles_Integration");
        }
...
/************************************************************************************************
 *     59029 characters generated by Talend Open Studio for ESB 
