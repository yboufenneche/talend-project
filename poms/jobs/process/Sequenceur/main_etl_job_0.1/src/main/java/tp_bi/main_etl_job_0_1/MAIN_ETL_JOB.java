...
package tp_bi.main_etl_job_0_1;
 ...
 * @status
 */
public class MAIN_ETL_JOB implements TalendJob {
	...
	private final String jobName = "MAIN_ETL_JOB";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(MAIN_ETL_JOB.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				tp_bi.src_stg_main_job_0_1.SRC_STG_MAIN_JOB childJob_tRunJob_1 = new tp_bi.src_stg_main_job_0_1.SRC_STG_MAIN_JOB();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				tp_bi.stg_dwh_main_job_0_1.STG_DWH_MAIN_JOB childJob_tRunJob_2 = new tp_bi.stg_dwh_main_job_0_1.STG_DWH_MAIN_JOB();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				tp_bi.dwh_agg_appel_distance_0_1.DWH_AGG_APPEL_DISTANCE childJob_tRunJob_3 = new tp_bi.dwh_agg_appel_distance_0_1.DWH_AGG_APPEL_DISTANCE();
				// pass DataSources
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				tp_bi.dwh_agg_appel_produit_0_1.DWH_AGG_APPEL_PRODUIT childJob_tRunJob_4 = new tp_bi.dwh_agg_appel_produit_0_1.DWH_AGG_APPEL_PRODUIT();
				// pass DataSources
	...
	public static void main(String[] args) {
		final MAIN_ETL_JOB MAIN_ETL_JOBClass = new MAIN_ETL_JOB();

		int exitCode = MAIN_ETL_JOBClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = MAIN_ETL_JOB.class.getClassLoader()
					.getResourceAsStream("tp_bi/main_etl_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = MAIN_ETL_JOB.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : MAIN_ETL_JOB");
		}
...
/************************************************************************************************
 * 51889 characters generated by Talend Open Studio for ESB on the 3 November
 * 2023 at 23:37:42 CET
 ************************************************************************************************/