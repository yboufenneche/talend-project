...
package tp_bi.src_stg_main_job_0_1;
...
/**
 * Job: SRC_STG_MAIN_JOB Purpose: Job principale<br>
 * Description: Job principale <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class SRC_STG_MAIN_JOB implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "SRC_STG_MAIN_JOB";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				SRC_STG_MAIN_JOB.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SRC_STG_MAIN_JOB.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		tp_bi.stg_jobs_paralleles_0_1.STG_Jobs_Paralleles childJob_tRunJob_3 = new tp_bi.stg_jobs_paralleles_0_1.STG_Jobs_Paralleles();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		tp_bi.src_stg_client_0_1.SRC_STG_CLIENT childJob_tRunJob_1 = new tp_bi.src_stg_client_0_1.SRC_STG_CLIENT();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		tp_bi.src_stg_appel_0_1.SRC_STG_APPEL childJob_tRunJob_2 = new tp_bi.src_stg_appel_0_1.SRC_STG_APPEL();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final SRC_STG_MAIN_JOB SRC_STG_MAIN_JOBClass = new SRC_STG_MAIN_JOB();

        int exitCode = SRC_STG_MAIN_JOBClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SRC_STG_MAIN_JOB.class.getClassLoader().getResourceAsStream("tp_bi/src_stg_main_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SRC_STG_MAIN_JOB.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SRC_STG_MAIN_JOB");
        }
...
/************************************************************************************************
 *     43599 characters generated by Talend Open Studio for ESB 
