...
package tp_bi.stg_dwh_main_job_0_1;
...
/**
 * Job: STG_DWH_MAIN_JOB Purpose: Job principale<br>
 * Description: Job principale <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class STG_DWH_MAIN_JOB implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "STG_DWH_MAIN_JOB";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				STG_DWH_MAIN_JOB.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(STG_DWH_MAIN_JOB.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		tp_bi.jobs_paralleles_integration_0_1.Jobs_Paralleles_Integration childJob_tRunJob_3 = new tp_bi.jobs_paralleles_integration_0_1.Jobs_Paralleles_Integration();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		tp_bi.stg_dwh_client_0_1.STG_DWH_CLIENT childJob_tRunJob_1 = new tp_bi.stg_dwh_client_0_1.STG_DWH_CLIENT();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		tp_bi.stg_dwh_appel_0_1.STG_DWH_APPEL childJob_tRunJob_2 = new tp_bi.stg_dwh_appel_0_1.STG_DWH_APPEL();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final STG_DWH_MAIN_JOB STG_DWH_MAIN_JOBClass = new STG_DWH_MAIN_JOB();

        int exitCode = STG_DWH_MAIN_JOBClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = STG_DWH_MAIN_JOB.class.getClassLoader().getResourceAsStream("tp_bi/stg_dwh_main_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = STG_DWH_MAIN_JOB.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : STG_DWH_MAIN_JOB");
        }
...
/************************************************************************************************
 *     43631 characters generated by Talend Open Studio for ESB 
