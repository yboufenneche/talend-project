...
package tp_bi.stg_jobs_paralleles_0_1;
...
/**
 * Job: STG_Jobs_Paralleles Purpose: Séquenceur des jobs de chargements des sources sans l'espace tempraire<br>
 * Description: Séquenceur des jobs de chargements des sources sans l'espace tempraire <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class STG_Jobs_Paralleles implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "STG_Jobs_Paralleles";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				STG_Jobs_Paralleles.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(STG_Jobs_Paralleles.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		tp_bi.src_stg_distance_0_1.SRC_STG_DISTANCE childJob_tRunJob_1 = new tp_bi.src_stg_distance_0_1.SRC_STG_DISTANCE();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		tp_bi.src_stg_direction_0_1.SRC_STG_DIRECTION childJob_tRunJob_2 = new tp_bi.src_stg_direction_0_1.SRC_STG_DIRECTION();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		tp_bi.src_stg_produit_0_1.SRC_STG_PRODUIT childJob_tRunJob_3 = new tp_bi.src_stg_produit_0_1.SRC_STG_PRODUIT();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		tp_bi.src_stg_offre_0_1.SRC_STG_OFFRE childJob_tRunJob_4 = new tp_bi.src_stg_offre_0_1.SRC_STG_OFFRE();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final STG_Jobs_Paralleles STG_Jobs_ParallelesClass = new STG_Jobs_Paralleles();

        int exitCode = STG_Jobs_ParallelesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = STG_Jobs_Paralleles.class.getClassLoader().getResourceAsStream("tp_bi/stg_jobs_paralleles_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = STG_Jobs_Paralleles.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : STG_Jobs_Paralleles");
        }
...
/************************************************************************************************
 *     58917 characters generated by Talend Open Studio for ESB 
