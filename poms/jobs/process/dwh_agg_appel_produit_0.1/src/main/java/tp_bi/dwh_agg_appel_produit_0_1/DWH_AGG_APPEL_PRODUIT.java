...
package tp_bi.dwh_agg_appel_produit_0_1;
...
/**
 * Job: DWH_AGG_APPEL_PRODUIT Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class DWH_AGG_APPEL_PRODUIT implements TalendJob {
...
public String getMySQL_TP_BI_Database(){
	...
	private final String jobName = "DWH_AGG_APPEL_PRODUIT";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				DWH_AGG_APPEL_PRODUIT.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(DWH_AGG_APPEL_PRODUIT.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class appel_outStruct implements routines.system.IPersistableRow<appel_outStruct> {
    final static byte[] commonByteArrayLock_TP_BI_DWH_AGG_APPEL_PRODUIT = new byte[0];
    static byte[] commonByteArray_TP_BI_DWH_AGG_APPEL_PRODUIT = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TP_BI_DWH_AGG_APPEL_PRODUIT.length) {
				if(length < 1024 && commonByteArray_TP_BI_DWH_AGG_APPEL_PRODUIT.length == 0) {
   					commonByteArray_TP_BI_DWH_AGG_APPEL_PRODUIT = new byte[1024];
				} else {
   					commonByteArray_TP_BI_DWH_AGG_APPEL_PRODUIT = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TP_BI_DWH_AGG_APPEL_PRODUIT, 0, length);
			strReturn = new String(commonByteArray_TP_BI_DWH_AGG_APPEL_PRODUIT, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TP_BI_DWH_AGG_APPEL_PRODUIT) {
	...
	class AggOperationStruct_tAggregateRow_1 { // G_OutBegin_AggR_100
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				int result = DEFAULT_HASHCODE;
							...
							result = prime * result + ((this.Lib_Produit == null) ? 0 : this.Lib_Produit.hashCode());
		...
		public boolean equals(Object obj) {
			...
			final AggOperationStruct_tAggregateRow_1 other = (AggOperationStruct_tAggregateRow_1) obj;
							...
							if (this.Lib_Produit == null) {
								if (other.Lib_Produit != null) 
									return false;
							} else if (!this.Lib_Produit.equals(other.Lib_Produit)) 
								return false;
...
appel_out_java.Lib_Produit = appel_in_java.Lib_Produit;
...
operation_finder_tAggregateRow_1.Lib_Distance = appel_out_java.Lib_Distance;
			...
			operation_finder_tAggregateRow_1.Lib_Produit = appel_out_java.Lib_Produit;
	...
	if(operation_result_tAggregateRow_1 == null) { // G_OutMain_AggR_001
		...
		operation_result_tAggregateRow_1.Lib_Distance = operation_finder_tAggregateRow_1.Lib_Distance;
				...
				operation_result_tAggregateRow_1.Lib_Produit = operation_finder_tAggregateRow_1.Lib_Produit;
...
String tableName_tDBOutput_1 = "dwh_agg_appel_distance";
...
int count_tDBOutput_1=0;
            ...
            try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1 + "`(`Lib_Distance` VARCHAR(15)  ,`Pays` VARCHAR(15)  ,`Mois_Appel` VARCHAR(2)  ,`Type_Offre` VARCHAR(8)  ,`Id_Direction` INT(10)  ,`Lib_Produit` VARCHAR(8)  ,`Duree` INT(10)  ,`Nb_Appel` INT(0)  )");
            }

				String insert_tDBOutput_1 = "INSERT INTO `" + "dwh_agg_appel_distance" + "` (`Lib_Distance`,`Pays`,`Mois_Appel`,`Type_Offre`,`Id_Direction`,`Lib_Produit`,`Duree`,`Nb_Appel`) VALUES (?,?,?,?,?,?,?,?)";
 ...
 */
	...
	currentComponent="tAggregateRow_1_AGGIN";
            				    ...
            				    appel_out.Lib_Produit = aggregated_row_tAggregateRow_1.Lib_Produit;
...
} else {pstmt_tDBOutput_1.setString(1, appel_out.Lib_Distance);
}

                            if(appel_out.Pays == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, appel_out.Pays);
}

                            if(appel_out.Mois_Appel == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, appel_out.Mois_Appel);
}

                            if(appel_out.Type_Offre == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, appel_out.Type_Offre);
}

                            if(appel_out.Id_Direction == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(5, appel_out.Id_Direction);
}

                            if(appel_out.Lib_Produit == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(6, appel_out.Lib_Produit);
}

                            if(appel_out.Duree == null) {
pstmt_tDBOutput_1.setNull(7, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(7, appel_out.Duree);
}

                            if(appel_out.Nb_Appel == null) {
pstmt_tDBOutput_1.setNull(8, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(8, appel_out.Nb_Appel);
}
 ...
 */
    ...
    public static void main(String[] args){
        final DWH_AGG_APPEL_PRODUIT DWH_AGG_APPEL_PRODUITClass = new DWH_AGG_APPEL_PRODUIT();

        int exitCode = DWH_AGG_APPEL_PRODUITClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = DWH_AGG_APPEL_PRODUIT.class.getClassLoader().getResourceAsStream("tp_bi/dwh_agg_appel_produit_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = DWH_AGG_APPEL_PRODUIT.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : DWH_AGG_APPEL_PRODUIT");
        }
...
/************************************************************************************************
 *     96858 characters generated by Talend Open Studio for ESB 
