...
package tp_bi.src_stg_direction_0_1;
...
/**
 * Job: SRC_STG_DIRECTION Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class SRC_STG_DIRECTION implements TalendJob {
...
public String getMySQL_TP_BI_Database(){
	...
	private final String jobName = "SRC_STG_DIRECTION";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				SRC_STG_DIRECTION.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SRC_STG_DIRECTION.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class direction_outStruct implements routines.system.IPersistableRow<direction_outStruct> {
    final static byte[] commonByteArrayLock_TP_BI_SRC_STG_DIRECTION = new byte[0];
    static byte[] commonByteArray_TP_BI_SRC_STG_DIRECTION = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final direction_outStruct other = (direction_outStruct) obj;
	...
	public void copyDataTo(direction_outStruct other) {
	...
	public void copyKeysDataTo(direction_outStruct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TP_BI_SRC_STG_DIRECTION.length) {
				if(length < 1024 && commonByteArray_TP_BI_SRC_STG_DIRECTION.length == 0) {
   					commonByteArray_TP_BI_SRC_STG_DIRECTION = new byte[1024];
				} else {
   					commonByteArray_TP_BI_SRC_STG_DIRECTION = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TP_BI_SRC_STG_DIRECTION, 0, length);
			strReturn = new String(commonByteArray_TP_BI_SRC_STG_DIRECTION, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TP_BI_SRC_STG_DIRECTION) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.Lib_Direction = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.Lib_Direction,dos);
     ...
     * Compare keys
     */
    public int compareTo(direction_outStruct other) {
...
public static class direction_inStruct implements routines.system.IPersistableRow<direction_inStruct> {
    final static byte[] commonByteArrayLock_TP_BI_SRC_STG_DIRECTION = new byte[0];
    static byte[] commonByteArray_TP_BI_SRC_STG_DIRECTION = new byte[0];
...
direction_outStruct direction_out = new direction_outStruct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"direction_out");
					}
...
String tableName_tDBOutput_1 = "stg_refdirection";
...
int count_tDBOutput_1=0;
            ...
            try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1 + "`(`Id_Direction` INT(10)   not null ,`Lib_Direction` VARCHAR(15)  ,primary key(`Id_Direction`))");
            }

				String insert_tDBOutput_1 = "INSERT INTO `" + "stg_refdirection" + "` (`Id_Direction`,`Lib_Direction`) VALUES (?,?)";
...
direction_outStruct direction_out_tmp = new direction_outStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.MySQL_TP_BI_Password; 
		    ...
		    String dbquery_tDBInput_1 = "SELECT \n  `src_refdirection`.`Id_Direction`, \n  `src_refdirection`.`Lib_Direction`\nFROM `src_refdirection`";
            ...
            direction_in.Id_Direction = rs_tDBInput_1.getInt(1);
        	...
        	direction_in.Lib_Direction = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
...
direction_out_tmp.Id_Direction = direction_in.Id_Direction ;
direction_out_tmp.Lib_Direction = direction_in.Lib_Direction ;
direction_out = direction_out_tmp;
...
if(direction_out != null) { 
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"direction_out");
					}
        ...
        whetherReject_tDBOutput_1 = false;
                            pstmt_tDBOutput_1.setInt(1, direction_out.Id_Direction);

                            if(direction_out.Lib_Direction == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, direction_out.Lib_Direction);
}
 ...
 */
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"direction_out");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final SRC_STG_DIRECTION SRC_STG_DIRECTIONClass = new SRC_STG_DIRECTION();

        int exitCode = SRC_STG_DIRECTIONClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SRC_STG_DIRECTION.class.getClassLoader().getResourceAsStream("tp_bi/src_stg_direction_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SRC_STG_DIRECTION.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SRC_STG_DIRECTION");
        }
...
/************************************************************************************************
 *     55469 characters generated by Talend Open Studio for ESB 
