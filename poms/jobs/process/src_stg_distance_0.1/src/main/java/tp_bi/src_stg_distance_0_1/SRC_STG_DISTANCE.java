...
package tp_bi.src_stg_distance_0_1;
...
/**
 * Job: SRC_STG_DISTANCE Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class SRC_STG_DISTANCE implements TalendJob {
...
public String getMySQL_TP_BI_Database(){
	...
	private final String jobName = "SRC_STG_DISTANCE";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				SRC_STG_DISTANCE.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SRC_STG_DISTANCE.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class distance_outStruct implements routines.system.IPersistableRow<distance_outStruct> {
    final static byte[] commonByteArrayLock_TP_BI_SRC_STG_DISTANCE = new byte[0];
    static byte[] commonByteArray_TP_BI_SRC_STG_DISTANCE = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final distance_outStruct other = (distance_outStruct) obj;
	...
	public void copyDataTo(distance_outStruct other) {
	...
	public void copyKeysDataTo(distance_outStruct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TP_BI_SRC_STG_DISTANCE.length) {
				if(length < 1024 && commonByteArray_TP_BI_SRC_STG_DISTANCE.length == 0) {
   					commonByteArray_TP_BI_SRC_STG_DISTANCE = new byte[1024];
				} else {
   					commonByteArray_TP_BI_SRC_STG_DISTANCE = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TP_BI_SRC_STG_DISTANCE, 0, length);
			strReturn = new String(commonByteArray_TP_BI_SRC_STG_DISTANCE, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TP_BI_SRC_STG_DISTANCE) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.Desc_Distance = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.Desc_Distance,dos);
     ...
     * Compare keys
     */
    public int compareTo(distance_outStruct other) {
...
public static class distance_inStruct implements routines.system.IPersistableRow<distance_inStruct> {
    final static byte[] commonByteArrayLock_TP_BI_SRC_STG_DISTANCE = new byte[0];
    static byte[] commonByteArray_TP_BI_SRC_STG_DISTANCE = new byte[0];
...
distance_outStruct distance_out = new distance_outStruct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"distance_out");
					}
...
String tableName_tDBOutput_1 = "stg_refdistance";
...
int count_tDBOutput_1=0;
            ...
            try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1 + "`(`Id_Distance` INT(10)   not null ,`Lib_Distance` VARCHAR(50)  ,`Desc_Distance` VARCHAR(50)  ,primary key(`Id_Distance`))");
            }

				String insert_tDBOutput_1 = "INSERT INTO `" + "stg_refdistance" + "` (`Id_Distance`,`Lib_Distance`,`Desc_Distance`) VALUES (?,?,?)";
...
distance_outStruct distance_out_tmp = new distance_outStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.MySQL_TP_BI_Password; 
		    ...
		    String dbquery_tDBInput_1 = "SELECT \n  `src_refdistance`.`Id_Distance`, \n  `src_refdistance`.`Lib_Distance`, \n  `src_refdistance`.`Desc_Distance`\nFR"
+"OM `src_refdistance`";
            ...
            distance_in.Id_Distance = rs_tDBInput_1.getInt(1);
        	...
        	distance_in.Lib_Distance = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								distance_in.Desc_Distance = null;
							} else {
	                         		
        	distance_in.Desc_Distance = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
		                    }
...
distance_out_tmp.Id_Distance =  distance_in.Id_Distance ;
distance_out_tmp.Lib_Distance = (distance_in.Lib_Distance != null && ! distance_in.Lib_Distance.isEmpty() )  ?  distance_in.Lib_Distance : "Non renseigné"   ;
distance_out_tmp.Desc_Distance = distance_in.Desc_Distance ;
distance_out = distance_out_tmp;
...
if(distance_out != null) { 
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"distance_out");
					}
        ...
        whetherReject_tDBOutput_1 = false;
                            pstmt_tDBOutput_1.setInt(1, distance_out.Id_Distance);

                            if(distance_out.Lib_Distance == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, distance_out.Lib_Distance);
}

                            if(distance_out.Desc_Distance == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, distance_out.Desc_Distance);
}
 ...
 */
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"distance_out");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final SRC_STG_DISTANCE SRC_STG_DISTANCEClass = new SRC_STG_DISTANCE();

        int exitCode = SRC_STG_DISTANCEClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SRC_STG_DISTANCE.class.getClassLoader().getResourceAsStream("tp_bi/src_stg_distance_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SRC_STG_DISTANCE.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SRC_STG_DISTANCE");
        }
...
/************************************************************************************************
 *     56687 characters generated by Talend Open Studio for ESB 
