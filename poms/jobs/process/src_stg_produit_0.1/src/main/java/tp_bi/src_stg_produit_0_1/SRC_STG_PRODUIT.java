...
package tp_bi.src_stg_produit_0_1;
...
/**
 * Job: SRC_STG_PRODUIT Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class SRC_STG_PRODUIT implements TalendJob {
...
public String getMySQL_TP_BI_Database(){
	...
	private final String jobName = "SRC_STG_PRODUIT";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				SRC_STG_PRODUIT.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SRC_STG_PRODUIT.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class produit_outStruct implements routines.system.IPersistableRow<produit_outStruct> {
    final static byte[] commonByteArrayLock_TP_BI_SRC_STG_PRODUIT = new byte[0];
    static byte[] commonByteArray_TP_BI_SRC_STG_PRODUIT = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final produit_outStruct other = (produit_outStruct) obj;
	...
	public void copyDataTo(produit_outStruct other) {
	...
	public void copyKeysDataTo(produit_outStruct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TP_BI_SRC_STG_PRODUIT.length) {
				if(length < 1024 && commonByteArray_TP_BI_SRC_STG_PRODUIT.length == 0) {
   					commonByteArray_TP_BI_SRC_STG_PRODUIT = new byte[1024];
				} else {
   					commonByteArray_TP_BI_SRC_STG_PRODUIT = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TP_BI_SRC_STG_PRODUIT, 0, length);
			strReturn = new String(commonByteArray_TP_BI_SRC_STG_PRODUIT, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TP_BI_SRC_STG_PRODUIT) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.Desc_Produit = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.Desc_Produit,dos);
     ...
     * Compare keys
     */
    public int compareTo(produit_outStruct other) {
...
public static class produit_inStruct implements routines.system.IPersistableRow<produit_inStruct> {
    final static byte[] commonByteArrayLock_TP_BI_SRC_STG_PRODUIT = new byte[0];
    static byte[] commonByteArray_TP_BI_SRC_STG_PRODUIT = new byte[0];
...
produit_outStruct produit_out = new produit_outStruct();
RejetStruct Rejet = new RejetStruct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"produit_out");
					}
...
String tableName_tDBOutput_1 = "stg_refproduit";
...
int count_tDBOutput_1=0;
            ...
            try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1 + "`(`Id_Produit` INT(10)   not null ,`Lib_Produit` VARCHAR(8)  ,`Desc_Produit` VARCHAR(20)  ,primary key(`Id_Produit`))");
            }

				String insert_tDBOutput_1 = "INSERT INTO `" + "stg_refproduit" + "` (`Id_Produit`,`Lib_Produit`,`Desc_Produit`) VALUES (?,?,?)";
...
produit_outStruct produit_out_tmp = new produit_outStruct();
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.MySQL_TP_BI_Password; 
				...
				String url_tDBInput_1 = "jdbc:mysql://" + context.MySQL_TP_BI_Server + ":" + context.MySQL_TP_BI_Port + "/" + "src" + "?" + context.MySQL_TP_BI_AdditionalParams;
		    ...
		    String dbquery_tDBInput_1 = "SELECT \n  `src_refproduit`.`Id_Produit`, \n  `src_refproduit`.`Lib_Produit`, \n  `src_refproduit`.`Desc_Produit`\nFROM `sr"
+"c_refproduit`";
            ...
            produit_in.Id_Produit = rs_tDBInput_1.getInt(1);
        	...
        	produit_in.Lib_Produit = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								produit_in.Desc_Produit = null;
							} else {
	                         		
        	produit_in.Desc_Produit = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
		                    }
...
produit_out_tmp.Id_Produit = produit_in.Id_Produit ;
produit_out_tmp.Lib_Produit = (produit_in.Lib_Produit != null && ! produit_in.Lib_Produit.isEmpty()) ? StringHandling.UPCASE(produit_in.Lib_Produit) : "Inconnu";
produit_out_tmp.Desc_Produit = produit_in.Desc_Produit ;
produit_out = produit_out_tmp;
...
Rejet_tmp.Id_Produit = produit_in.Id_Produit ;
Rejet_tmp.Lib_Produit = produit_in.Lib_Produit ;
Rejet_tmp.Desc_Produit = produit_in.Desc_Produit ;
Rejet = Rejet_tmp;
} // closing filter/reject
// ###############################
...
if(produit_out != null) { 
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"produit_out");
					}
        ...
        whetherReject_tDBOutput_1 = false;
                            pstmt_tDBOutput_1.setInt(1, produit_out.Id_Produit);

                            if(produit_out.Lib_Produit == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, produit_out.Lib_Produit);
}

                            if(produit_out.Desc_Produit == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, produit_out.Desc_Produit);
}
...
///////////////////////		
				...
				strBuffer_tLogRow_1.append(
				                String.valueOf(Rejet.Id_Produit)							
				);
	    		...
	    		if(Rejet.Lib_Produit != null) { //              
                    							
       
				strBuffer_tLogRow_1.append(
				                String.valueOf(Rejet.Lib_Produit)							
				);
	    		...
	    		if(Rejet.Desc_Produit != null) { //              
                    							
       
				strBuffer_tLogRow_1.append(
				                String.valueOf(Rejet.Desc_Produit)							
				);
 ...
 */
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"produit_out");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final SRC_STG_PRODUIT SRC_STG_PRODUITClass = new SRC_STG_PRODUIT();

        int exitCode = SRC_STG_PRODUITClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SRC_STG_PRODUIT.class.getClassLoader().getResourceAsStream("tp_bi/src_stg_produit_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SRC_STG_PRODUIT.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SRC_STG_PRODUIT");
        }
...
/************************************************************************************************
 *     65858 characters generated by Talend Open Studio for ESB 
