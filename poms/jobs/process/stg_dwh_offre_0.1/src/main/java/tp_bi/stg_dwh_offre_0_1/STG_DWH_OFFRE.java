...
package tp_bi.stg_dwh_offre_0_1;
...
/**
 * Job: STG_DWH_OFFRE Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class STG_DWH_OFFRE implements TalendJob {
...
public String getMySQL_TP_BI_Database(){
	...
	private final String jobName = "STG_DWH_OFFRE";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				STG_DWH_OFFRE.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(STG_DWH_OFFRE.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class offre_outStruct implements routines.system.IPersistableRow<offre_outStruct> {
    final static byte[] commonByteArrayLock_TP_BI_STG_DWH_OFFRE = new byte[0];
    static byte[] commonByteArray_TP_BI_STG_DWH_OFFRE = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TP_BI_STG_DWH_OFFRE.length) {
				if(length < 1024 && commonByteArray_TP_BI_STG_DWH_OFFRE.length == 0) {
   					commonByteArray_TP_BI_STG_DWH_OFFRE = new byte[1024];
				} else {
   					commonByteArray_TP_BI_STG_DWH_OFFRE = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TP_BI_STG_DWH_OFFRE, 0, length);
			strReturn = new String(commonByteArray_TP_BI_STG_DWH_OFFRE, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TP_BI_STG_DWH_OFFRE) {
...
String tableName_tDBOutput_1 = "dwh_ref_offre";
...
int count_tDBOutput_1=0;
            ...
            try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1 + "`(`Id_Offre` INT(10)   not null ,`Lib_Offre` VARCHAR(15)  ,`Desc_Offre` VARCHAR(30)  ,`Type_Offre` VARCHAR(8)  ,primary key(`Id_Offre`))");
            }

				String insert_tDBOutput_1 = "INSERT INTO `" + "dwh_ref_offre" + "` (`Id_Offre`,`Lib_Offre`,`Desc_Offre`,`Type_Offre`) VALUES (?,?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.MySQL_TP_BI_Password; 
            ...
            offre_in.Id_Offre = rs_tDBInput_1.getInt(1);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								offre_in.Lib_Offre = null;
							} else {
	                         		
        	offre_in.Lib_Offre = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								offre_in.Desc_Offre = null;
							} else {
	                         		
        	offre_in.Desc_Offre = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
		                    }
...
Var.Type_Offre = TypeOffre.typeOffre(offre_in.Id_Offre) ;// ###############################
        // ###############################
        // # Output tables
...
offre_out_tmp.Lib_Offre = offre_in.Lib_Offre ;
offre_out_tmp.Desc_Offre = offre_in.Desc_Offre ;
offre_out_tmp.Type_Offre = Var.Type_Offre ;
...
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
                            ...
                            if(offre_out.Type_Offre == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, offre_out.Type_Offre);
}
 ...
 */
    ...
    public static void main(String[] args){
        final STG_DWH_OFFRE STG_DWH_OFFREClass = new STG_DWH_OFFRE();

        int exitCode = STG_DWH_OFFREClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = STG_DWH_OFFRE.class.getClassLoader().getResourceAsStream("tp_bi/stg_dwh_offre_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = STG_DWH_OFFRE.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : STG_DWH_OFFRE");
        }
...
/************************************************************************************************
 *     56690 characters generated by Talend Open Studio for ESB 
