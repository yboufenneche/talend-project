...
package tp_bi.stg_dwh_produit_0_1;
...
/**
 * Job: STG_DWH_PRODUIT Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class STG_DWH_PRODUIT implements TalendJob {
...
public String getMySQL_TP_BI_Database(){
	...
	private final String jobName = "STG_DWH_PRODUIT";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				STG_DWH_PRODUIT.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(STG_DWH_PRODUIT.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class produit_outStruct implements routines.system.IPersistableRow<produit_outStruct> {
    final static byte[] commonByteArrayLock_TP_BI_STG_DWH_PRODUIT = new byte[0];
    static byte[] commonByteArray_TP_BI_STG_DWH_PRODUIT = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TP_BI_STG_DWH_PRODUIT.length) {
				if(length < 1024 && commonByteArray_TP_BI_STG_DWH_PRODUIT.length == 0) {
   					commonByteArray_TP_BI_STG_DWH_PRODUIT = new byte[1024];
				} else {
   					commonByteArray_TP_BI_STG_DWH_PRODUIT = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TP_BI_STG_DWH_PRODUIT, 0, length);
			strReturn = new String(commonByteArray_TP_BI_STG_DWH_PRODUIT, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TP_BI_STG_DWH_PRODUIT) {
...
String tableName_tDBOutput_1 = "dwh_ref_produit";
...
int count_tDBOutput_1=0;
            ...
            try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
				...
				String insert_tDBOutput_1 = "INSERT INTO `" + "dwh_ref_produit" + "` (`Id_Produit`,`Lib_Produit`,`Desc_Produit`) VALUES (?,?,?)";
 ...
 */
    ...
    public static void main(String[] args){
        final STG_DWH_PRODUIT STG_DWH_PRODUITClass = new STG_DWH_PRODUIT();

        int exitCode = STG_DWH_PRODUITClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = STG_DWH_PRODUIT.class.getClassLoader().getResourceAsStream("tp_bi/stg_dwh_produit_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = STG_DWH_PRODUIT.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : STG_DWH_PRODUIT");
        }
...
/************************************************************************************************
 *     56433 characters generated by Talend Open Studio for ESB 
